...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = species)) +
  geom_point() +
  theme_minimal() + 
  scale_colour_manual(values = c("green4", "orange", "gray1")) + #change the color
...
ggplot(penguins, aes(x = body_mass_g)) +
  geom_histogram(color = "#000000", fill="#FCB514") + 
  theme_minimal()
```
...
ggplot(penguins, aes(x = body_mass_g, fill = species)) +
  ...
  scale_fill_manual(values=c("#FFB612", "#C60C30", "#003087")) + 
  theme_minimal()
```
...
ggplot(penguins, aes(x = bill_depth_mm, y = flipper_length_mm, color = species)) +
  geom_point() +
  theme_minimal() + 
  scale_colour_manual(values = c("#FFB612", "#C60C30", "#003087")) + #change the color
  geom_point(size = 2) #change the size 
...
ggplot(penguins, aes(x = bill_depth_mm, y = flipper_length_mm, color = body_mass_g)) +
  geom_point() +
  theme_minimal() + 
  scale_color_gradient(low = "#0038A8", high = "#D60270")
  geom_point(size = 3) #change the size 

# It creates a spectrum of colors
```
